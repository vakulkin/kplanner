...
class AdGroupKeyword(Base):
    ...
    clerk_user_id = Column(String(255), nullable=False)
    broad = Column(Boolean, default=False, nullable=False)
    phrase = Column(Boolean, default=False, nullable=False)
    exact = Column(Boolean, default=False, nullable=False)
    neg_broad = Column(Boolean, default=False, nullable=False)
    neg_phrase = Column(Boolean, default=False, nullable=False)
    neg_exact = Column(Boolean, default=False, nullable=False)
